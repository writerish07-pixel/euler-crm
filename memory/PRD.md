...
## Iteration 19 (2026-06) — Google Sheet cleaned for final use
- One-time cleanup of the LIVE master sheet (GSHEET_ID 173a0…, service-account Editor) removing all CRM/test-appended rows, keeping original master data. Done directly on the live sheet (affects preview + production; no redeploy needed).
