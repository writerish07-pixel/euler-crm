// Cloudflare Workers Builds entry (repo root). Proxies /api to Railway so
// staff phones talk to the same host they already opened (mobile carriers
// often drop *.up.railway.app even when the CRM page loads).
